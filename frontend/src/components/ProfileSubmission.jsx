...
const ProfileSubmission = () => {
  ...
  const filteredSubmissions = allSubmissionsOfUser.filter((submission) => {
            ...
            <div className="stats shadow bg-base-100">
              ...
              <div className="stat p-2">
                ...
                <div className="stat-value text-lg text-success">
                  {
                    allSubmissionsOfUser.filter((s) => s.status === "Accepted")
                      .length
                  }
                </div>
              </div>
                ...
                >
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center p-4 cursor-pointer hover:bg-base-200">
                    <div className="flex flex-col md:flex-row md:items-center gap-3 w-full">
                      <div
                        className={`badge badge-lg ${getStatusClass(submission.status)}`}
                      >
