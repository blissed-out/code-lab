...
import { createProblem, getAllProblems, getProblem, updateProblem, deleteProblem, getAllSolvedProblemsByUser } from "../controllers/problem.controller.js";
...
authRoute.get("/get-problem/:id", isLoggedIn, getProblem)
